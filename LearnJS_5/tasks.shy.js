...
const popularTechnologies = technologies.filter((item) => item.popularity > 80);
const averagePopularity =
  popularTechnologies.reduce((acc, item) => {
    return acc + item.popularity;
  }, 0) / popularTechnologies.length;
