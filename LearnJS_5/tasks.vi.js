...
const popularTechnologies = technologies.filter(technologies => technologies.popularity > 80);
const averagePopularity = popularTechnologies.reduce((sum, technologies) => sum + technologies.popularity, 0) / popularTechnologies.length;
